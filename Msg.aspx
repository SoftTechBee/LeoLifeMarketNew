...
<head  runat="server">
    ...
    <title>Registration Success| Leo Life Marketing</title>
                ...
                <div class="card">
                   <div class="card-body" >
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-primary d-grid w-100" OnClick="btnLogin_Click"   Text="Login Now!" />
