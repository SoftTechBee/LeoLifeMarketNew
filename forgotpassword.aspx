...
<head  runat="server">
    ...
    <title>Forgot Password - Pages | Leo Life Marketing</title>
...
<body id="top" data-theme-color="color-yellow"  style="background-image:url(bg.jpg); background-size:cover; background-position:center">
 ...
 <!-- Content -->
         ...
         <%--   <div class="authentication-inner">--%>
                ...
                <div class="card">
                   <div class="card-body" >                        <!-- Logo -->
                        ...
                        <!-- /Logo -->
                        <%--<h4 class="mb-2">Welcome to Leo Life Marketing!  </h4>--%>
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-primary d-grid w-100" OnClick="btnLogin_Click"   Text="Sent To Mail" />
                        ...
                        <p class="text-center">
                            <span>Back To Leo Life Marketing?</span>
                            <a href="login.aspx">
                                <span>Login</span>
                            </a>
                        </p>
    ...
    <!-- / Content -->
<%-- <div class="buy-now">
        <a href="index.html" target="_blank" class="btn btn-danger btn-buy-now">Back To Leo Life Marketing</a>
    </div>--%>
