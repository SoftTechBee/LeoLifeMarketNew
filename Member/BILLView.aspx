<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="BILLView.aspx.cs" Inherits="User_Default" %>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-12">
                                                    <asp:Button ID="btnview" runat="server" OnClick="btnview_Click" Text="Print"   class=" btn btn-warning btn-sm" />
                                                </div>
                                                <%--<div class="col-sm-12" style="text-align: right!important">
                                                    <asp:Button ID="btnpay" runat="server" OnClick="btnpay_Click" Text="Pay Now" Width="20%" class=" btn btn-secondary  btn-sm" />
                                                </div>--%>
                                            </div>
                                        </div>
