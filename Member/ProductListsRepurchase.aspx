<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="ProductListsRepurchase.aspx.cs" Inherits="User_Default" %>
          ...
          <p>  
              <asp:Label ID="lbsuccess" runat="server" Text="There is  some thing wrong........."></asp:Label> </p>
                 ...
                 <div class="alert alert-light  dark ">
                           ...
                           <p class="page-title"><b> <asp:label ID="lbpack"     runat="server"  CssClass="text-danger" Text="Re-Purchase" ></asp:label> Product Details</b></p>
                       <div class="notification-box" style="text-align:right">
                          <a href="PurchaseHistoryRepurchase.aspx"><b>My Cart</b> <i class="fa fa-cart-plus text-danger  " ></i></a>
