...
public partial class User_EditProfile : System.Web.UI.Page
{
    ...
    protected void bntsubmit_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           int a = objamd.Register(0, lbSponser.Text, lbSponserName.Text, txtName.Text, lbUserName.Text, Password, txtFName.Text, lbUserName.Text, side, DOJ, txtAddress.Text, "", txtState.Text, "India", txtEmail.Text, txtMobile.Text, lbStatus.Text, txtNName.Text,txtNRelation.Text, "", "", "", "", rdSex.SelectedItem.Text, DOB, txtpincode.Text, "", "", "", "", "", DOJ, "", DOA, "", "", "","", "U");
            if (a > 0)
            {
