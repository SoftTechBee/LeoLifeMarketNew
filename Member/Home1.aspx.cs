    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SessionData.Get<string>("Newuser") != null)
        {
            try
            {
                ...
                myInput.Value = "https://Leo Life Marketing.live/register.aspx?Sponsor=" + username + "&Side=Left";
                myInputRight.Value = "https://Leo Life Marketing.live/register.aspx?Sponsor=" + username + "&Side=Right";
                lbreffsidLeft.Text = "https://Leo Life Marketing.live/register.aspx?Sponsor=" + username+"&Side=Left";
                lbreffsidRight.Text = "https://Leo Life Marketing.live/register.aspx?Sponsor=" + username + "&Side=Right";

                lbTotalIncome1.Text = objdashboard.TotalIncome(username);
