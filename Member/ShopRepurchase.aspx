<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="ShopRepurchase.aspx.cs" Inherits="User_Default" %>
          ...
          <p>  
              <asp:Label ID="lbsuccess" runat="server" Text="There is  some thing wrong........."></asp:Label> </p>
                 ...
                 <div class="alert alert-light  dark ">
                                 ...
                                 <p class="page-title"><b>Repurchase Product</b></p>
