...
<head  runat="server">
    ...
    <title>Referral - Pages | Leo Life Marketing</title>
                   ...
                   <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                             <a href="index.html" class="app-brand-link gap-2">
                                   ...
                                   <img src="Loginassets/img/logo/logo.png" width="60%" />
                      ...
                      <%--<h4 class="mb-2">Welcome to UPTO!  </h4>--%>
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-1 row">
                               ...
                               <asp:TextBox ID="lbsponserid"  placeholder="Enter Sponsor ID"   ReadOnly="true" required="" runat="server" class="form-control" ></asp:TextBox>
                  ...
                  <label for="email" class="form-label">Product Delivery Address</label>
                   ...
                   <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" required="" Height="50px"  class="form-control" placeholder=" Delivery  Address With PinCode "></asp:TextBox>              
                           ...
                           <div class="mb-1">
                                ...
                                <asp:TextBox ID="txtemail"  OnTextChanged="txtemail_TextChanged" AutoPostBack="true" type="email"  required=""   runat="server" class="form-control" placeholder="Enter Email"></asp:TextBox>
                        ...
                        <p class="text-center">
                            <span>Already on our  Leo Life Marketing?</span>
                            <a href="login.aspx">
