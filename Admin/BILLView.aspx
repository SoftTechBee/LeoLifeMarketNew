<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="BILLView.aspx.cs" Inherits="User_Default" %>
                                ...
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div>
                                                ...
                                                <span class="text-600 text-110 text-blue align-middle">FXTREME DIGITAL LIFE SKILL INDIA PVT. LTD. </span>
                                            </div>
                                            <div class="text-grey-m2">
                                                <div class="my-1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <asp:Button ID="btnview" runat="server" OnClick="btnview_Click" Text="Print" Width="30%" class=" btn bg-warning btn-sm" />
                                            </div>
                                            <%--<div class="col-sm-12" style="text-align: right!important">
                                                <asp:Button ID="btnadd" runat="server" OnClick="btnadd_Click" Text="+Product" Width="41%" class=" btn bg-warning  btn-sm" />
                                            </div>--%>
                                        </div>
                                    </div>
