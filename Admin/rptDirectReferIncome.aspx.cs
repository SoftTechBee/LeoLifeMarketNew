...
public partial class Admin_rptlevelIncome : System.Web.UI.Page
{
    ...
    private void loadlist()
    {
        try
        {
            string sql = "select r.name,r.doa,r.dateofjoin,a.username,sum(cast (a.credit as real)) as totalincome from register r inner join dbo.account a on r.username=a.username  where a.valu='DIRECTMATCHING' ";
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "View")
        {
            ...
            Response.Redirect("rptViewIncome.aspx?username=" + username + "&type=DIRECTMATCHING");
        }
    }
