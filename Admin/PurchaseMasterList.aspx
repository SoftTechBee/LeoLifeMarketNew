<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseMasterList.aspx.cs" Inherits="Admin_AccountMasterList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card ">
                            <div class="card-body">
                                <h5 class="card-title">Purchase Wallet Master List </h5>
