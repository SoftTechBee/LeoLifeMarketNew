...
<li class="list-group-item px-0 bg-transparent"> 
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="flex-grow-1">
      <h6 class="mb-0">Direct Sponsor Bonus</h6>
    </div>
    <div class="d-flex align-items-center gap-3">
...
<li class="list-group-item px-0 bg-transparent"> 
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="flex-grow-1">
      <h6 class="mb-0">Direct Referal Matching Bonus</h6>
    </div>
    <div class="d-flex align-items-center gap-3">
      <p class="mb-0"><asp:Label ID="lbdirectmatching" runat="server" Text="0"></asp:Label> <%=SessionData.Get<string>("Currency")%></p>
      <p class="mb-0 fw-bold text-success"><a href="rptMatchingBinaryIncome.aspx"class="btn-sm">View</a></p>
    </div>
  </div>
</li>
...
<li class="list-group-item px-0 bg-transparent"> 
  <div class="d-flex align-items-center gap-3">
    ...
    <div class="flex-grow-1">
      <h6 class="mb-0">Total Reward Bonus</h6>
    </div>
    <div class="d-flex align-items-center gap-3">
