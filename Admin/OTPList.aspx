<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="OTPList.aspx.cs" Inherits="User_TopUpWallet" %>
              ...
              <asp:Label ID="lbdanger" runat="server" Text="There is  some thing wrong........."></asp:Label> </p>
                ...
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h5 class="page-title">Pending Delivery List</h5>
                    </div>
    ...
    <ItemTemplate>
        <tr>
            ...
            <%-- <td> <%#Eval("PaidAmt") %></td>
               ...
               <td> <%#Eval("TotalBV") %></td>--%>
             <td> <asp:Button ID="Button1" runat="server" Text="Delivered" CssClass="btn  btn-sm btn-danger" CommandArgument='<%#Eval("DeliveryOTP") %>' CommandName="View" /> </td>
