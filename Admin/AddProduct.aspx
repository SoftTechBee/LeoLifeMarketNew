...
<div class="col-lg-4">
                         <asp:Label ID="lbdiscount"   runat="server" Text="0" CssClass="form-control"></asp:Label>
                          ...
                          <label class="control-label col-lg-2">Product PV </label>
                          <div class="col-lg-4">
                         <asp:TextBox ID="txtbv"  placeholder="Enter Product PV"   runat="server" CssClass="form-control"></asp:TextBox>
        ...
        <div class="col-lg-12"style="overflow:auto;">
                      ...
                      <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                          ...
                          <ItemTemplate>
                           ...
                           <td> <img id="lbimg" runat="server" src='<%#Eval("Imgurl") %>' height="50" width="50" /></td>
